"""Forward hooks for injecting dynamically-generated LoRA weights into a frozen LLM.

This module provides utilities to:

* Attach pre/post forward hooks to specific sub-modules (attention, MLP)
  within each transformer layer.
* Inject LoRA delta weights (A, B matrices) generated by the hypernetwork
  as additive residuals during the forward pass — without modifying the
  frozen base model's parameters.
* Clean up hooks after inference or between checkpoint swaps.
"""
