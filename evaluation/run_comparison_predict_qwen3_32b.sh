#!/usr/bin/env bash
# ===========================================================================
# PHASE-Tree Comparison Baselines — Qwen3-32B (multi-dataset, 8-GPU)
# ===========================================================================
# Runs rag / pag / cfg predictions for all 8 LongEvoRoleBench datasets with
# Qwen3-32B, mirroring results/*/comparison/main/{rag,pag,cfg} layout but
# writing to a separate tag so Qwen2.5-7B main results are preserved:
#   results/<DATASET>/comparison/qwen3_32b/<METHOD>/<SPLIT>/predictions.jsonl
#
# Usage:
#   bash evaluation/run_comparison_predict_qwen3_32b.sh
...
echo ""
echo "╔══════════════════════════════════════════════════════════════╗"
echo "║  Comparison Predictions — ${RESULTS_TAG} (Qwen3-32B)"
echo "╠══════════════════════════════════════════════════════════════╣"
echo "║  Model      : ${MODEL}"
